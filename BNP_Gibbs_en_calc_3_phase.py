    ...
    def _calculate_surface_tension(
        ...
        def _calculate_surface_tension_solid_to_solid(xB_alpha, xB_beta, phase_alpha, phase_beta):
            ...
            def _calculate_incoherent_solid_solid():
                k_incoherent = 0.917
                f_incoherent = 1.045
                omega_A_incoherent = _calculate_omega_for_surface_tension(v_alpha, f_incoherent)
                omega_B_incoherent = _calculate_omega_for_surface_tension(v_beta, f_incoherent)
